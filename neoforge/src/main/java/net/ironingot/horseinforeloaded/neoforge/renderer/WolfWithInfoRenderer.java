...
import net.ironingot.horseinforeloaded.neoforge.render_state.layer.WolfWithInfoArmorLayer;
import net.ironingot.horseinforeloaded.neoforge.render_state.layer.WolfWithInfoCollarLayer;
